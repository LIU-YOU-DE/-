<template>
  <div class="app-container">
    ...
    <el-card class="box-card">
      <h3>购买须知</h3>
      <el-button :plain="true" type="primary" @click="handleAttributeShow">添加标签</el-button>
    ...
    <div class="op-container">
      ...
      <el-button type="primary" @click="handleEdit" v-permission="['PUT /rule/{id}']">更新规则</el-button>
    </div>
  </div>
</template>
