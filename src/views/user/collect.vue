<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model.trim="listQuery.userId" clearable class="filter-item" style="width: 200px;" placeholder="请输入用户ID"/>
      <el-input v-model.trim="listQuery.valueId" clearable class="filter-item" style="width: 200px;" placeholder="请输入商品ID"/>
