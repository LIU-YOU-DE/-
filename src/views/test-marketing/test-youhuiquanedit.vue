<template>
  <div class="app-container" style="width:90%;margin:0 auto;">
    <div class="tabletop">
      ...
      <el-form ref="goods" :rules="rules" :model="goods" label-width="150px" style="margin-left:30%;">
        <el-form-item label="面值" prop="faceValue">
          <el-input-number v-model="goods.faceValue" :precision="2" :step="1" />元
        </el-form-item>
        ...
        <el-form-item label="优惠券价格" prop="price">
          <el-input-number v-model="goods.price" :step="1" />元
        </el-form-item>
        ...
        <el-form-item label="备注" prop="remark">
          <el-col :span="12">
            <el-input type="textarea" autosize v-model="goods.remark" />
          </el-col>
        </el-form-item>
    ...
    <div class="box-card" v-if="showtable">
      ...
      <el-dialog :visible.sync="attributeVisiable" title="设置商品参数">
        ...
        >
          ...
          <el-table :data="carlist" border highlight-current-row @selection-change="changeFun" style="margin-top:10px;">
            ...
            <el-table-column align="center" label="汽车id" prop="id" />
            <el-table-column align="center" label="汽车名字" prop="name" />
            <el-table-column align="center" property="coverUrl" label="汽车图片">
              <template slot-scope="scope">
                <img :src="scope.row.coverUrl" width="40" />
              </template>
            </el-table-column>
    ...
    <div class="op-container" style="display:flex;justify-content:center;margin-top:20px;">
      ...
      <el-button @click="handleEdit">修改优惠券</el-button>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleCancel: function() {
      this.$router.push({ path: "/marketing/youhuiquan" });
    },
    handleEdit: function() {
      // debugger;
