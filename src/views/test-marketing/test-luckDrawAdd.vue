  ...
  <div class="app-container" style="width:95%;margin:0 auto;">
    ...
    <div style="width:70%;margin:0 auto;">
      <el-form ref="goods"  :model="goods" label-width="150px">
        <el-form-item label="抽奖活动名称" prop="activityName" class="inputstyle">
          <el-input v-model="goods.activityName" />
        </el-form-item>
        <el-form-item label="抽奖活动描述" prop="description">
        ...
        <el-form-item label="抽奖活动类型" prop="type">
      ...
      <p class="address" style="font-size:16px;margin-bottom:40px;margin-left:50px;"><svg-icon icon-class="qi" class-name="card-panel-icon svg" />抽奖奖品设置</p>
      <div style="width:90%;margin:0 auto;">
        <p style="font-size:14px;color:#666;">所有奖品中奖概率的和为100,如果输入小数将向下取整。</p>
        <el-button :plain="true" @click="attributeVisiable=true" style="margin-right:20px;margin-bottom:10px;">添加奖品</el-button>
    ...
    <div class="op-container" style="display:flex;justify-content:center;margin-top:20px;">
      <el-button @click="handActivityadd">添加抽奖活动</el-button>
    </div>
  </div>
