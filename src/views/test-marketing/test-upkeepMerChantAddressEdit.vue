    ...
    <div style="width:30%;margin:0 auto;">
      <el-form ref="goods"  :model="goods" label-width="150px">
        ...
        <div style="text-align:center;">
            <el-button @click="handUpdateMerchar">更新商家</el-button>
        </div>
    </div>
...
<script>
import {updateMearchar } from '@/api/storage'
