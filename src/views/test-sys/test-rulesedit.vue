<template>
  <div class="app-container">
    ...
    <div class="editbox">
      <div class="tabletop">
        <p class="address">规则修改</p>
      </div>
      <el-form ref="goods" :rules="rules" :model="goods" label-width="250px" style="margin-left:15%;">
        <p class="address" style="font-size:15px;margin-bottom:40px;margin-left:-15%;"><svg-icon icon-class="qi" class-name="card-panel-icon svg" />常规设置</p>
        ...
        <el-form-item label="礼品兑换规则图片" prop="giftRulePicture">
          <el-upload
            :headers="headers"
            :action="uploadPath"
...
export default {
  ...
  methods: {
    ...
    handleCancel: function() {
      this.$router.push({ path: '/test-sys/test-rules' })
    },
    handleEdit: function() {
      // debugger;
