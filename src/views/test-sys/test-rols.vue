<template>
  <div class="app-container">
    ...
    <div>
      ...
      <el-table-column align="center" label="操作" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-permission="['POST /role/{id}']" size="mini" @click="handleUpdate(scope.row)">编辑</el-button>
          <el-button v-permission="['DELETE /role/{id}']" type="danger" size="mini" @click="handleDelete(scope.row.id)">删除</el-button>
          <el-button v-permission="['GET /role/permissions']" size="mini" @click="handlePermission(scope.row)">授权</el-button>
        </template>
      </el-table-column>
    </el-table>
    </div>
    ...
    <!-- 权限配置对话框 -->
    <div class="popContainer" v-show="permissionbox">
      <div class="perbox">
