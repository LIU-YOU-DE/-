<template>
  <div class="app-youhuiquanadd">
    ...
    <el-card v-if="showtable" class="box-card">
      <h3>指定汽车</h3>
      ...
      <el-dialog :visible.sync="attributeVisiable" title="指定车型">
        ...
        >
          ...
          <el-table :data="carlist" border highlight-current-row @selection-change="changeFun">
            ...
            <el-table-column align="center" property="coverUrl" label="车型封面图片">
              <template slot-scope="scope">
                <img :src="scope.row.coverUrl" width="40" >
              </template>
            </el-table-column>
    ...
    <div class="op-container">
      ...
      <el-button type="primary" @click="handleEdit" v-permission="['POST /coupon']">添加优惠券</el-button>
    </div>
  </div>
</template>
