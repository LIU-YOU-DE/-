<template>
  <div class="app-container">
    ...
    <div class="filter-container;" style="border:1px solid #DCDFE6;margin-bottom:20px;height:115px;">
      ...
      >查找</el-button>
      <el-button
        v-permission="['POST /storage/create']"
        class="filter-item"
        style="margin-top:8px;display:inline-block;"
        icon="el-icon-edit"
        @click="setMask"
      ...
      <el-button
        class="filter-item"
        v-permission="['POST /storage/delete/multiple']"
        style="margin-top:8px;display:inline-block;"
    ...
    >
      ...
      <el-table-column align="center" label="操作" width="300" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button
            v-permission="['POST /storage/update','POST /storage/read']"
            size="mini"
            @click="handleUpdate(scope.row)"
          >编辑</el-button>

          <el-button
            v-permission="['POST /storage/delete']"
            type="danger"
            size="mini"
