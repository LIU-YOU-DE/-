  ...
  <div style="width:90%;margin:0 auto;">
    ...
    <div class="tabletop" style="position:relative;">
      ...
      <div style="position:absolute;display:inline-block;right:0;margin-top:10px;margin-right:20px;">
        ...
        <el-button size="mini" @click="deleteOrder">关闭订单</el-button>
      </div>
    </div>
    ...
    <el-table border :data="list">
      ...
      <el-table-column align="center" label="小计" prop="number"></el-table-column>
...
<script>
import { detailOrder,updateOrderStatus } from "@/api/order";
export default {
  data(){
    return {
      status:undefined,
  ...
  methods:{
    ...
    //   }
    //   updateOrderStatus(this.$route.query.id,this.type).then(response=>{
    //     this.$notify.success({
    //       title:"成功",
    //       message:"订单已取消"
    //     })
