<template>
  <div style="width:90%;margin:0 auto;">
    ...
    <div style="width:83%;display:flex;margin:0 auto;justify-content:space-between;" >
      ...
      <p class="title" style="margin-right:20px;">支付订单</p>
    ...
    <div style="width:88%;display:flex;margin:0 auto;justify-content:space-between;" >
      ...
      <p class="title2" style="width:19%;"></p>
    ...
    <h3 class="table-title"><svg-icon icon-class="qi" class-name="card-panel-icon " class="svg"/>基本信息</h3>
