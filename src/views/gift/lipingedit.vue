<template>
  <div class="app-container">
    <el-card class="box-card">
      ...
      <el-form ref="goods" :model="goods" label-width="150px">
        ...
        <el-form-item label="礼品单位" prop="unit">
          <el-input class="custom" v-model="goods.unit"/>
        </el-form-item>
        <el-form-item label="预警数量" prop="warnStock">
          <el-input-number :step="1" :min="0" v-model="goods.warnStock"/>
        </el-form-item>
        <el-form-item label="预扣数量" prop="withhold" >
          <el-input class="custom" v-model="goods.withhold" :disabled="true"/>
        </el-form-item>
        <!-- <el-form-item label="详情图文本" prop="details">
          <el-input class="custom" v-model="goods.details"/>
        </el-form-item> -->
        ...
        <el-form-item label="详情图图片url">
          ...
          >
            <img v-if="goods.detailUrl" :src="goods.detailUrl" class="PicUrlImg" >
    ...
    <div class="op-container">
      ...
      <el-button type="primary" @click="handleEdit">更新礼品</el-button>
    </div>
  </div>
</template>
...
<script>
import { detailliping, listCatAndBrand, editGoods } from '@/api/liping'
...
export default {
  ...
  created() {
    this.init()
    this.handleCategoryChange(this.goods.categoryId)
  },
  methods: {
    init: function() {
      ...
      detailliping(goodsId).then(response => {
        ...
        this.categoryIds = response.data.data.categoryId
    ...
    handleCategoryChange(value) {
      ...
      //   this.fenleiid=this.goods.categoryId
      //   console.log(value);
    },
    ...
    handleEdit: function() {
      this.goods.categoryId = this.goods.categoryId[this.goods.categoryId.length - 1]
      console.log()
      const finalGoods = {
